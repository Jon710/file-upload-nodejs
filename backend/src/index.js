...
io.on("connection", (socket) => logger.info("Alguém conectou! " + socket.id));

// usamos emit para enviar uma mensagem para toda a rede, e emitir em um canal
// ou evento especifico
